        ...
        public static IEnumerable<object[]> UserSharedInfoDeserializationTests
        {
            get
            {
                ...
                // "6d0d2ee1-6aa3-42ea-9833-ac592bfc6613" - from sso v0.3.0
                {
                    ...
                    expectedSharedInfoMock.Setup(i => i.CreationDateTime)
                        .Returns(new DateTime(2021, 12, 30, 18, 51, 32, 706));
                    ...
                    tests.Add(new DeserializationTestElement<UserSharedInfo>(sourceDocument,
                        expectedSharedInfoMock.Object));
                }
