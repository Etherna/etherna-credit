...
namespace Etherna.Credit.Extensions
{
    public class LoggerEnrichmentConfigurationExtensionsTest
    {
        // Tests.
        [Fact]
        public void WithCreditExceptionDetails_WithMongoCommandException_KeepsScalarsAndDropsDocuments()
        {
            // Arrange.
        ...
        [Fact]
        public void WithCreditExceptionDetails_WithMongoConnectionException_KeepsInnerException()
        {
            // Arrange.
        ...
        public void WithCreditExceptionDetails_WithMongoException_DropsEveryDriverObjectGraph(MongoException exception, string graphProperty)
        {
        ...
        [Fact]
        public void WithCreditExceptionDetails_WithOtherException_KeepsObjectProperties()
        {
            // Arrange.
            var exception = new ValidationException(
                new ValidationResult("Title is required", ["Title"]),
            ...
            // Assert.
            Assert.Equal("Title is required", ScalarOf(DictionaryOf(details, "ValidationResult"), "ErrorMessage"));
        }
        ...
        private static Dictionary<string, LogEventPropertyValue> EnrichExceptionDetails(Exception exception)
        {
            ...
            using var logger = new LoggerConfiguration()
                .Enrich.WithCreditExceptionDetails()
